...
const ITEM_POOL = [
  ...
  { id: 'choice_band',        name: 'European Malt',   desc: '+40% flavor damage, -30% aroma damage',                  icon: '🌾' },
  { id: 'choice_specs',       name: 'Hop Oils',  desc: '+40% aroma damage, -30% flavor damage',                  icon: '🫙' },
  ...
  { id: 'scope_lens',         name: 'Centrifuge',      desc: '20% crit chance (+50% damage on crit)',                  icon: '🔬' },
  { id: 'razor_claw',         name: 'C-Box',         desc: '20% crit chance (+50% damage on crit)',                  icon: '📦' },
  // ── Defensive & battle-effect ─────────────────────────────────────────────
  { id: '"barrel-aged"_helmet', name: 'Steel Jacket', desc: 'Attacker takes 15% of their max HP on each hit',         icon: '🧥' },
  { id: 'shell_bell',         name: 'Closed Transfer Loop',       desc: 'Heal 25% of damage dealt',                               icon: '🔄' },
  { id: 'eviolite',           name: 'WIP Recipe',       desc: '+50% DEF & Sp.Def if holder is not fully evolved',       icon: '📋' },
  { id: 'assault_vest',       name: 'Thermal Insulation',      desc: '+50% DEF & Sp.Def',                                      icon: '🧊' },
  ...
  { id: 'focus_band',         name: 'Steel Toe Boots',     desc: '10% chance to survive a KO with 1 HP',                  icon: '🥾' },
  { id: 'air_balloon',        name: 'CO2 Purge',       desc: 'Immune to Brown-type moves',                             icon: '💨' },
  // ── Type-boosting items (all 18 types) ────────────────────────────────────
  { id: 'silk_scarf',         name: 'Pale Malt',      desc: '+50% Blonde flavor/aroma damage',                        icon: '🌾' },
  { id: 'charcoal',           name: 'Crystal Malt',     desc: '+50% Red flavor/aroma damage',                           icon: '🍂' },
  { id: 'mystic_lager',       name: 'Noble Hops',  desc: '+50% Lager flavor/aroma damage',                         icon: '🌿' },
  { id: 'magnet',             name: 'Sourvisiae', desc: '+50% Sour flavor/aroma damage',                          icon: '🧪', minMap: 4 },
  { id: 'miracle_seed',       name: 'Double Dry Hop',     desc: '+50% IPA flavor/aroma damage',                           icon: '🍃' },
  { id: 'hop_kief',           name: 'Hop Kief',           desc: '+50% Cryo flavor/aroma damage',                          icon: '❄️', minMap: 4 },
  { id: 'black_belt',         name: 'Extra Long Boil',  desc: '+50% Barleywine flavor/aroma damage',                    icon: '🔥' },
  { id: 'brett_barb',         name: 'Funky Dregs', desc: '+50% Brett flavor/aroma damage',                         icon: '🦠', minMap: 4 },
  { id: 'soft_sand',          name: 'Biscuit Malt',   desc: '+50% Brown flavor/aroma damage',                         icon: '🍞', minMap: 4 },
  { id: 'sharp_beak',         name: 'Bitter Orange Peel',        desc: '+50% Wheat flavor/aroma damage',                         icon: '🍊' },
  { id: 'twisted_spoon',      name: 'Candi Sugar',desc: '+50% Belgian flavor/aroma damage',                       icon: '🍬', minMap: 4 },
  { id: 'silver_powder',      name: 'Warm Temps',    desc: '+50% Saison flavor/aroma damage',                        icon: '🌡️', minMap: 4 },
  { id: 'hard_stone',         name: 'Specialty Barrel',       desc: '+50% Barrel-aged flavor/aroma damage',                   icon: '🛢️', minMap: 4 },
  { id: 'spell_tag',          name: 'Carbon Filter',      desc: '+50% Seltzer flavor/aroma damage',                       icon: '⬛', minMap: 4 },
  { id: 'stout_fang',         name: 'Double Mash', desc: '+50% Stout flavor/aroma damage',                         icon: '🫕', minMap: 6 },
  { id: 'trade_agreement',    name: 'Trade Agreement',    desc: '+50% Export flavor/aroma damage',                        icon: '🤝', minMap: 4 },
  { id: 'dehusked_malts',     name: 'Dehusked Malts',     desc: '+50% Cascadian flavor/aroma damage',                     icon: '🖤', minMap: 4 },
  { id: 'marshmallow_fluff',  name: 'Marshmallow Fluff',  desc: '+50% Pastry flavor/aroma damage',                        icon: '🍡', minMap: 4 },
];
