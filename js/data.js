...
const ITEM_POOL = [
  // ── XP & levelling ───────────────────────────────────────────────────────
  { id: 'lucky_egg',          name: 'Previous Batch Notes', desc: '+3 levels per win instead of +2',                                    icon: '📓', minMap: 2 },
  ...
  { id: 'late_lunch',         name: 'Late Lunch',           desc: 'Always goes last; +50% damage',                                       icon: '🍱', minMap: 2 },
  { id: 'overcarbonated',     name: 'Overcarbonated',       desc: 'First hit deals 2x damage, then lose 50% current HP (min 10% max HP)', icon: '💥' },
  { id: 'pasteurization',     name: 'Pasteurization',       desc: '+100% damage; holder can never gain levels',                          icon: '🧪', minMap: 2 },
  ...
  { id: 'magnet',             name: 'Sourvisiae',           desc: '+40% Sour flavor/aroma damage',                                       icon: '🧪', minMap: 2 },
  { id: 'miracle_seed',       name: 'Double Dry Hop',       desc: '+40% IPA flavor/aroma damage',                                        icon: '🍃' },
  { id: 'hop_kief',           name: 'Hop Kief',             desc: '+40% Cryo flavor/aroma damage',                                       icon: '❄️', minMap: 2 },
  { id: 'black_belt',         name: 'Extra Long Boil',      desc: '+40% Barleywine flavor/aroma damage',                                 icon: '🔥' },
  { id: 'brett_barb',         name: 'Funky Dregs',          desc: '+40% Brett flavor/aroma damage',                                      icon: '🦠', minMap: 2 },
  { id: 'soft_sand',          name: 'Biscuit Malt',         desc: '+40% Brown flavor/aroma damage',                                      icon: '🍞', minMap: 2 },
  { id: 'sharp_beak',         name: 'Bitter Orange Peel',   desc: '+40% Wheat flavor/aroma damage',                                      icon: '🍊' },
  { id: 'twisted_spoon',      name: 'Candi Sugar',          desc: '+40% Belgian flavor/aroma damage',                                    icon: '🍬', minMap: 2 },
  { id: 'silver_powder',      name: 'Warm Temps',           desc: '+40% Saison flavor/aroma damage',                                     icon: '🌡️', minMap: 2 },
  { id: 'hard_stone',         name: 'Specialty Barrel',     desc: '+40% Barrel-aged flavor/aroma damage',                                icon: '🛢️', minMap: 2 },
  { id: 'spell_tag',          name: 'Carbon Filter',        desc: '+40% Seltzer flavor/aroma damage',                                    icon: '⬛', minMap: 2 },
  { id: 'stout_fang',         name: 'Double Mash',          desc: '+40% Stout flavor/aroma damage',                                      icon: '🫕', minMap: 2 },
  { id: 'trade_agreement',    name: 'Trade Agreement',      desc: '+40% Export flavor/aroma damage',                                     icon: '🤝', minMap: 2 },
  { id: 'dehusked_malts',     name: 'Dehusked Malts',       desc: '+40% Cascadian flavor/aroma damage',                                  icon: '🖤', minMap: 2 },
  { id: 'marshmallow_fluff',  name: 'Marshmallow Fluff',    desc: '+40% Pastry flavor/aroma damage',                                     icon: '🍡', minMap: 2 },
];
...
const spriteUrl = CUSTOM_IDS.has(id)
  ? (isShiny ? `sprites/${id}s.png` : `sprites/${id}.png`)
  : isShiny
...
const RIVAL_BREWERIES = [
  {
    ...
    roster: [
      ...
      { speciesId:142, name:'Aerodactyl', brewName:'Aero Dactyl Imperial Barrel-aged Wheat', types:['Barrel-aged','Wheat'],
      ...
      { speciesId:139, name:'Omastar',   brewName:'Ohm A Star Imperial Barrel-aged Lager',   types:['Barrel-aged','Lager'],
      ...
      { speciesId:141, name:'Kabutops',  brewName:'Ka Boo Tops Imperial Barrel-aged Lager',  types:['Barrel-aged','Lager'],
      ...
      { speciesId:346, name:'Cradily',   brewName:'Cray Dilly Barrel-aged IPA',               types:['Barrel-aged','Ipa'],
      ...
      { speciesId:348, name:'Armaldo',   brewName:'Arm Aldo Barrel-aged Saison',              types:['Barrel-aged','Saison'],
      ...
      { speciesId:369, name:'Relicanth', brewName:'Reel E Canth Lager Barrel-aged',           types:['Lager','Barrel-aged'],
  ...
  },
  {
    ...
    roster: [
      ...
      { speciesId:143, name:'Snorlax',   brewName:'Snor Lax Imperial Blonde',      types:['Blonde'],
      ...
      { speciesId:202, name:'Wobbuffet', brewName:'Wob Buffet Imperial Belgian',   types:['Belgian'],
      ...
      { speciesId:321, name:'Wailord',   brewName:'Wail Lord Imperial Lager',      types:['Lager'],
        baseStats:{hp:170,atk:90,def:45,speed:60,special:90,spdef:45},
        heldItems:[{id:'shell_bell',    name:'Closed Transfer Loop',  icon:'🔄', desc:'Heal 20% of damage dealt'}] },
      { speciesId:242, name:'Blissey',   brewName:'Bliss Ee Imperial Pastry Blonde', types:['Blonde'],
        baseStats:{hp:255,atk:10,def:10,speed:55,special:75,spdef:135},
        heldItems:[{id:'leftovers',     name:'Yeast Nutrient',        icon:'🧫', desc:'Restore 6% max HP per turn'}] },
      { speciesId:131, name:'Lapras',    brewName:'Lap Ras Imperial Lager Cryo',   types:['Lager','Cryo'],
  ...
  },
  {
    ...
    roster: [
      { speciesId:213, name:'Shuckle',   brewName:'Shuck El Saison Barrel-aged',         types:['Saison','Barrel-aged'],
        ...
        heldItems:[{id:'assault_vest',          name:'Thermal Insulation',icon:'🧊', desc:'+40% DEF & Sp.Def'}] },
      { speciesId:378, name:'Regice',    brewName:'Reg E Ice Imperial Cryo',             types:['Cryo'],
        baseStats:{hp:80,atk:50,def:100,speed:50,special:100,spdef:200},
        heldItems:[{id:'oak_barrel',            name:'Oak Barrel',        icon:'🛢️', desc:'-20% damage taken; -20% speed'}] },
      { speciesId:350, name:'Milotic',   brewName:'My Lot Ik Imperial Lager',            types:['Lager'],
  ...
  },
  {
    ...
    roster: [
      // introduced first → last
      { speciesId:291, name:'Ninjask',   brewName:'Nin Jask Saison Wheat',         types:['Saison','Wheat'],
        baseStats:{hp:61,atk:90,def:45,speed:160,special:50,spdef:50},
      ...
      { speciesId:135, name:'Jolteon',   brewName:'Jolt Eon Imperial Sour',        types:['Sour'],
        ...
        heldItems:[{id:'scope_lens',    name:'Centrifuge',        icon:'🔬', desc:'Double crit chance (12.5%); normal 1.5x crit damage'}] },
      { speciesId:169, name:'Crobat',    brewName:'Crow Bat Imperial Brett Wheat', types:['Brett','Wheat'],
        baseStats:{hp:85,atk:90,def:80,speed:130,special:70,spdef:80},
    ...
    {
    id: 'cloner',
    trainerSprite: 'scientist-gen4',
    name: 'Crazy Cloner',
    subtitle: 'That is a lot of Jacks with a lot of items.',
    icon: '️🧑‍🤝‍🧑',
    roster: [
      // introduced first → last
      ...
      { speciesId:6668, name:'Jack 5-nickname:Bauer',   brewName:'Jack 5-nickname:Bauer',         types:['Blonde', 'Pastry'],
        baseStats:{hp: 250,atk:80,def: 100,speed:30,special:60,spdef: 110},
        heldItems:[
			{ id: 'hop_extract',name: 'Hop Extract',desc: '+20% damage dealt; take 20% of damage dealt as recoil',icon: '🌿' },
			{ id: 'overcarbonated',name: 'Overcarbonated',desc: 'First hit deals 2x damage, then lose 50% current HP (min 10% max HP)', icon: '💥' },
			{ id: 'life_orb',name: 'Banquet Beer Stash',desc: '+30% damage; holder loses 10% max HP per hit',icon: '🍻' },
      ...
      { speciesId:6668, name:'Jack 6-nickname:Jack B',   brewName:'Jack 6-nickname:Jack B',         types:['Blonde', 'Pastry'],
        ...
        heldItems:[
			{ id: 'muscle_band',name: 'Grain Mill',desc: '+20% flavor damage',icon: '⚙️' },
			{ id: 'focus_band',name: 'Steel Toe Boots',desc: '15% chance to survive a KO with 1 HP',icon: '🥾' },
			{ id: 'marshmallow_fluff',name: 'Marshmallow Fluff',desc: '+40% Pastry flavor/aroma damage',icon: '🍡'},
			{ id: 'late_lunch',name: 'Late Lunch', desc: 'Always goes last; +50% damage', icon: '🍱'},
			{ id: 'life_orb',name: 'Banquet Beer Stash',desc: '+30% damage; holder loses 10% max HP per hit',icon: '🍻' },
			{ id: 'scope_lens',name: 'Centrifuge',desc: 'Double crit chance (12.5%); normal 1.5x crit damage',icon: '🔬' },
			{ id: 'razor_claw',name: 'C-Box',desc: 'Normal crit chance; crits deal 3x damage instead of 1.5x',icon: '📦' },		
		] },
